...
<?php
	...
	header("location:logOut.php");
     ...
     if(($_SESSION['User_Prev']!="Super")&&($_SESSION['User_Prev']!="Editor")){
		 echo "<script>alert('Not Admin or Editor'); </script>";
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Style/ListEdit.css" />
		 ...
		 <div class="Content">
		 	 ...
		 	 <div class="Nav_menu">
                ...
                <div class="add_img">
                     ...
                     <a href="Profiles/CreateProfile.php"> <img title="Add a new record" src="../imgs/Icons/add.png"> </a>

                </div>

                <div class="sub_img">

                     <a href="Profiles/Remove.php"> <img title="Remove a record" src="../imgs/Icons/Sub.png"> </a>
                 ...
                 <center>      
                    <div class="search_box">  
             	         ...
             	         <input type="text" placeholder="Keyword" class="searching" name="searching">
		 	 ...
		 	 <div class="Table_view">
		 	 		...
		 	 		<form method="POST" action="#">
                                     ...
                                     <?php $qRY = "select * from casetable "; $qRYE = " "; ?>
            			    		  ...
            			    		  <tr>
            			    		  	 ...
            			    		  	 <th><input type="submit" value="info"> </th>
            			    		  </tr>
                  ...
                  try{ 
                     ...
                     try{
                     		...
                     		//$qRY = "select * from casetable ORDER BY CaseID ASC";
                            ...
                            <tr>
            			    		  	 ...
            			    		  	 <td> <a href="Profiles/EditProfile.php?data=<?php echo $dat['CaseID']; ?>"> Edit </a> </td>
            			    		  </tr>
